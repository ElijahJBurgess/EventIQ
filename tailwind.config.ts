...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        "offrip-display": ["Barlow", "ui-sans-serif", "system-ui", "sans-serif"],
      ...
      colors: {
        ...
        citron: {
          DEFAULT: "hsl(var(--citron))",
          foreground: "hsl(var(--citron-foreground))",
        },
        vermillion: {
          DEFAULT: "hsl(var(--vermillion))",
          foreground: "hsl(var(--vermillion-foreground))",
        },
